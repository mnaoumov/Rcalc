...
PowerForMu(c(rep(1/10,10),rep(-1/10,10),rep(-1/10,10),rep(1/10,10)),rexp, c(.25,.25,.25),10000,10000)
PowerForMu(c(rep(2/10,10),rep(-2/10,10),rep(-2/10,10),rep(2/10,10)),rexp, c(.25,.25,.25),10000,10000)
PowerForMu(c(rep(3/10,10),rep(-3/10,10),rep(-3/10,10),rep(3/10,10)),rexp, c(.25,.25,.25),10000,10000)
PowerForMu(c(rep(4/10,10),rep(-4/10,10),rep(-4/10,10),rep(4/10,10)),rexp, c(.25,.25,.25),10000,10000)
PowerForMu(c(rep(5/10,10),rep(-5/10,10),rep(-5/10,10),rep(5/10,10)),rexp, c(.25,.25,.25),10000,10000)
PowerForMu(c(rep(6/10,10),rep(-6/10,10),rep(-6/10,10),rep(6/10,10)),rexp, c(.25,.25,.25),10000,10000)
PowerForMu(c(rep(7/10,10),rep(-7/10,10),rep(-7/10,10),rep(7/10,10)),rexp, c(.25,.25,.25),10000,10000)
PowerForMu(c(rep(8/10,10),rep(-8/10,10),rep(-8/10,10),rep(8/10,10)),rexp, c(.25,.25,.25),10000,10000)
